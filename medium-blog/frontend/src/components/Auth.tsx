...
import type { SignupInput } from "shudhanshu-common";
import axios from "axios";
import { BACKEND_END } from "../config";
...
export const Auth = ({type}: {type: "signup" | "signin"}) => {
    ...
    async function sendRequest() {
        try {
            const response = await axios.post(`${BACKEND_END}/api/v1/user/${type === "signup" ? "signup": "signin"}` , postInputs);
        ...
        <div className="flex justify-center">
            <div>
                ...
                <div className="pt-8">
                    ...
                    <LabelledInput label="Username"  placeholder="harkirat@gamil.com" onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
